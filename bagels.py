...
# Numbers are strings in this game because you aren't mathing. Remember that the string '026'
# is different from '26'. But in integers they mean the same thing. 
...
When I say:    That means:
    Fizz       One digit is correct but in the wrong position.
    Buzz       One digit is correct and in the right position.
    FizzBuzz   No digit is correct.
          
For example, if the secret number was 248 and your guess was 843, the 
clues would be Germi Pico.'''.format(NUM_DIGITS))
    ...
    while True: # Main game loop.
        ...
        # Ask player f they want to play again.
...
def getClues(guess, secretNum):
    """Returns a string with the fizz, buzz, fizzbuzz clues for a guess
